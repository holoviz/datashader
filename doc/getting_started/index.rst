...
The lastest releases are avalailable on the pyviz channel ``conda install -c pyviz datashader``
and the latest pre-release versions are avalailable on the dev-labelled channel
